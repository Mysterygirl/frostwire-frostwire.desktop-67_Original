...
/**
 * The horizontal pixx scroll bar.
 */
...
*/
  ...
  public void update(Graphics g)
  {
    ...
    drawB(gra,margin-h,_mouseDownUp);
    ...
    //fleche de droite
    drawInside(gra,w-_arrow,_arrow-2,_mouseDownDown);
    drawA(gra,w-margin+h,_mouseDownDown);
  ...
  private double getValue(int x,int y)
  {
    ...
    int px=x-margin-_base;
    return (_max-_min)*px/lng+_min;
  }
