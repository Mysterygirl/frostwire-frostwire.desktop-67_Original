...
public class ShareManager {
    ...
    public static boolean warnAboutSensitiveDirectory(File folder) {
        ...
        DialogOption retval = GUIMediator.showYesNoMessage(
                I18n.tr("<html><table width=400>The folder <i>{0}</i><br>is likely to contain sensitive or personal information.<br><br>FrostWire recommends that you <b>DO NOT</b> share this folder.<br><br>Are you sure you want to share it?</table></html>", dirName),
                DialogOption.NO);
